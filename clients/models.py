...
class Customer(models.Model):
    ...
    cust_plan = models.IntegerField(11)
...
class Users(models.Model):
    ...
    cust_id = models.IntegerField()  # ou ForeignKey si possible
    empl_id = models.IntegerField() 
    user_pseudo = models.CharField(max_length=100)
    user_email = models.CharField(max_length=100)
    user_password = models.CharField(max_length=100)
    created_at = models.DateTimeField(auto_now_add=True)
    user_status = models.IntegerField(default=1)  # ou ForeignKey si possible
...
class UserRole(models.Model):
    ...
    roles_id = models.IntegerField()  # ou ForeignKey si possible
